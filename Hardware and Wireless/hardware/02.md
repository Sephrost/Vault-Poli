...
the change happens only after the rising age of the clock.
### 43
![[hardware/converted/Slide 02/-43.png]]
0 is a non value, which acts as a reset.
This signal must be asynchronous, which allows it to take control of the circuit in an independent way.
### 44
...
We write only the logic component, the implementation and the layout are abstracted away.
### 51
